...
public class EmployeeController {
    ...
    @GetMapping("/checkpwd")
    public ResponseEntity checkpwd(@RequestParam String nwaCode) throws IncompleteDetailsProvided {
        if(nwaCode==null){
            throw new IncompleteDetailsProvided("Password missing");
        }
        return employeeServiceImpl.checkpwd(nwaCode);
    }
}
